...
# Application
An application built from https://github.com/rhdh-JslYoon-org/rhdhpai802-10 will be stored in [quay.io/rh-ee-lyoon/rhdhpai802-10](https://quay.io/rh-ee-lyoon/rhdhpai802-10) and deployed through GitOps. This application is accessible on port **8501**.